...
export default function OurWork() {
  ...
  return (
    <div className="pt-20">
      {/* Hero Section */}
      {/* Background Image */}
      <section className="relative pt-10 pb-14 px-6 flex flex-col items-center text-center overflow-hidden">
        ...
        {/* Hero Text */}
        <h1 className="text-3xl md:text-4xl font-semibold text-yellow-700 drop-shadow-sm animate-fade-in">
          Driving Africa's Tech Revolution
        </h1>
        <p className="max-w-2xl text-gray-600 dark:text-gray-300 text-lg animate-fade-in-delayed">
        ...
        {/* Glass Card */}
        <div className="mt-6 bg-white/70 dark:bg-gray-800/40 backdrop-blur-xl border border-white/20 dark:border-gray-700/40 rounded-3xl shadow-2xl py-6 px-10 w-full max-w-5xl animate-rise">
...
{/* ===================== PROJECTS SECTION ===================== */}
  ...
  <div className="max-w-6xl mx-auto px-6">
    ...
    <h2 className="text-2xl font-semibold text-center mb-12 text-yellow-500">
      Featured Events & Highlights
    </h2>

    {/* ===================== EVENT 1 ===================== */}
    <div className="relative rounded-xl overflow-hidden shadow-2xl mb-16">
    ...
    <div className="relative rounded-3xl overflow-hidden shadow-2xl">
      ...
      <section className="py-12 bg-gray-100 dark:bg-gray-900">
        <div className="max-w-7xl mx-auto px-6">
          <h2 className="text-3xl font-semibold text-center mb-16">Our Impact So Far</h2>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            {[
              ...
              <div key={stat.label}>
                <h3 className="text-3xl font-semibold text-primary">{stat.number}</h3>
                <p className="text-xl mt-1 text-gray-700 dark:text-gray-300">{stat.label}</p>
              </div>
            ))}
          </div>
        </div>
